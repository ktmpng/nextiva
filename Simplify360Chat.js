...
const Simplify360Chat = (function () {
  ...
  const changeChatPosition = () => {
    ...
    if (chatFrame) {
      chatFrame.style = `position: fixed;${chatStatus === "closed" ? ' top: calc(100vh - 6rem)' : `bottom:1rem;`};${chatPosition}:0;overflow: visible;z-index: 99999;HEIGHT:${chatStatus === "closed" ? "7rem" : "100%"
  ...
  const onChatClose = () => {
    ...
    if (chatFrame) {
      chatFrame.style.height = '7rem';
      chatFrame.style = `position: fixed;top:calc(100vh - 6rem);${chatPosition}:0; overflow: visible;z-index: 99999;height:${chatStatus === "closed" ? "7rem" : "100%"
